...
namespace EF_SQL_Practice.Model
{
    public partial class NWConsole_23_gplContext : DbContext
    {
        public NWConsole_23_gplContext()
        {
        }

        public NWConsole_23_gplContext(DbContextOptions<NWConsole_23_gplContext> options)
            : base(options)
        {
        }
